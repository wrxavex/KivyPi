...
if __name__ == "__main__":
    try:
        while True:
            ...
            if sht31.check_heater_status() == True:
                sht31.turn_heater_on()
                sht31.check_heater_status()
                sht31.turn_heater_off()
                    ...
                    publish.single("/SHT31/Temperature", "%5.2f " % (temperature), hostname="www.znh.tw" )
                    publish.single("/SHT31/Humidity", "%4.2f" % (humidity), hostname="www.znh.tw")
                    publish.single("/SHT31/Time", timenow, hostname="www.znh.tw")
                    publish.single("/SHT31/Count", count, hostname="www.znh.tw")
