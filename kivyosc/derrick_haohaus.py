...
my_id.set_to_new_ip()
my_id.my_movie = "/home/pi/haohaus/"+str(my_id.id_to_set)+".mp4"
...
def osc_all_play_yourself(dt):
    osc.sendMsg('/derrick/osc', dataArray=[0], ipAddr='192.168.1.231', port=serviceport)
    osc.sendMsg('/derrick/osc', dataArray=[0], ipAddr='192.168.1.232', port=serviceport)
    osc.sendMsg('/derrick/osc', dataArray=[0], ipAddr='192.168.1.233', port=serviceport)
    osc.sendMsg('/derrick/osc', dataArray=[0], ipAddr='192.168.1.234', port=serviceport)
    osc.sendMsg('/derrick/osc', dataArray=[0], ipAddr='192.168.1.235', port=serviceport)
    osc.sendMsg('/derrick/osc', dataArray=[0], ipAddr='192.168.1.236', port=serviceport)
    osc.sendMsg('/derrick/osc', dataArray=[0], ipAddr='192.168.1.237', port=serviceport)
    osc.sendMsg('/derrick/osc', dataArray=[0], ipAddr='192.168.1.238', port=serviceport)
    osc.sendMsg('/derrick/osc', dataArray=[0], ipAddr='192.168.1.239', port=serviceport)

    osc.sendMsg('/derrick/osc', dataArray=[0], ipAddr='192.168.1.231', port=activityport)
    osc.sendMsg('/derrick/osc', dataArray=[0], ipAddr='192.168.1.232', port=activityport)
    osc.sendMsg('/derrick/osc', dataArray=[0], ipAddr='192.168.1.233', port=activityport)
    osc.sendMsg('/derrick/osc', dataArray=[0], ipAddr='192.168.1.234', port=activityport)
    osc.sendMsg('/derrick/osc', dataArray=[0], ipAddr='192.168.1.235', port=activityport)
    osc.sendMsg('/derrick/osc', dataArray=[0], ipAddr='192.168.1.236', port=activityport)
    osc.sendMsg('/derrick/osc', dataArray=[0], ipAddr='192.168.1.237', port=activityport)
    osc.sendMsg('/derrick/osc', dataArray=[0], ipAddr='192.168.1.238', port=activityport)
    osc.sendMsg('/derrick/osc', dataArray=[0], ipAddr='192.168.1.239', port=activityport)
...
class OmxVideoPlayer:
    ...
    def videoPlay(self):
            ...
            self.proc = subprocess.Popen(['omxplayer', self.name, '--no-osd', '--aspect-mode ', 'fill', '--crop', self.crop, '--orientation ', '270', '--loop'], stdin=subprocess.PIPE)
...
v1 = OmxVideoPlayer("0,0,400,240", croparea_setter(my_id.id_to_set), "/home/pi/haohaus/1.mp4")
v2 = OmxVideoPlayer("400,0,800,240", croparea_setter(my_id.id_to_set), "/home/pi/haohaus/2.mp4")
v3 = OmxVideoPlayer("0,240,400,480", croparea_setter(my_id.id_to_set), "/home/pi/haohaus/3.mp4")
v4 = OmxVideoPlayer("400,240,800,480", croparea_setter(my_id.id_to_set), "/home/pi/haohaus/4.mp4")

f1 = OmxVideoPlayer("0,0,1280,720", croparea_setter(my_id.id_to_set), "/home/pi/haohaus/1.mp4")
f2 = OmxVideoPlayer("0,0,1280,720", croparea_setter(my_id.id_to_set), "/home/pi/haohaus/2.mp4")
f3 = OmxVideoPlayer("0,0,1280,720", croparea_setter(my_id.id_to_set), "/home/pi/haohaus/3.mp4")
f4 = OmxVideoPlayer("0,0,1280,720", croparea_setter(my_id.id_to_set), "/home/pi/haohaus/4.mp4")
f5 = OmxVideoPlayer("0,0,1280,720", croparea_setter(my_id.id_to_set), "/home/pi/haohaus/5.mp4")
f6 = OmxVideoPlayer("0,0,1280,720", croparea_setter(my_id.id_to_set), "/home/pi/haohaus/6.mp4")
f7 = OmxVideoPlayer("0,0,1280,720", croparea_setter(my_id.id_to_set), "/home/pi/haohaus/7.mp4")
f8 = OmxVideoPlayer("0,0,1280,720", croparea_setter(my_id.id_to_set), "/home/pi/haohaus/8.mp4")
f9 = OmxVideoPlayer("0,0,1280,720", croparea_setter(my_id.id_to_set), "/home/pi/haohaus/9.mp4")

v1fs = OmxVideoPlayer("0,0,800,480", "0,0,720,480", "/home/pi/haohaus/1.mp4")
v2fs = OmxVideoPlayer("0,0,800,480", "0,0,720,480", "/home/pi/haohaus/2.mp4")
